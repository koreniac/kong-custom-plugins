...
local policies = require "kong.plugins.custom-rate-limit.policies"
...
CustomRateLimitHandler.PRIORITY = 901
CustomRateLimitHandler.VERSION = "0.1.0"
...
local function get_identifier(conf)
  ...
  elseif conf.limit_by == "uid" then
    identifier = ngx.ctx.uid
  end
